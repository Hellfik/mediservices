 ...
 */
final class Version20191001210335 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pret DROP materiel_id, CHANGE commercial_id commercial_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pret ADD materiel_id INT DEFAULT NULL, CHANGE commercial_id commercial_id INT DEFAULT NULL');
